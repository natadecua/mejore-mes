...
export default function DesignI() {
  // Safe initial state with null check
  const [activeItem, setActiveItem] = useState(BOMS[0]?.children?.[1]?.children?.[0] || BOMS[0])
  ...
  if (!activeItem) return <div className="p-8 text-white bg-black h-screen">Initializing...</div>
      ...
      <aside className="w-96 bg-[#0f1116] border border-slate-800/50 rounded-3xl flex flex-col shadow-2xl overflow-hidden shrink-0">
        <div className="p-6 bg-slate-900/50 border-b border-slate-800">
           ...
           <div className="bg-black/40 border border-slate-800 p-4 rounded-2xl">
              ...
              <h3 className="text-white font-black text-lg leading-tight uppercase tracking-tight">{BOMS[0]?.name || 'No Project'}</h3>
           </div>
        </div>
              ...
              <div className="xl:col-span-5 flex flex-col gap-4">
                 <section className="bg-slate-900/50 border border-slate-800 rounded-3xl p-6 flex flex-col gap-4">
                    ...
                    <div className="space-y-4">
                       ...
                       <div className="bg-black/40 p-4 rounded-xl text-xs text-slate-300 italic border border-slate-800/50 leading-relaxed font-medium">
